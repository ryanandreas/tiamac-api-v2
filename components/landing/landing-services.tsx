...
import { Wind, Wrench, ArrowRight, PackagePlus, Gauge } from "lucide-react"
...
const services = [
  ...
  },
  {
    ...
    color: "bg-green-100/50 text-[#66B21D]",
  },
]
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <div 
              key={index} 
              className="group bg-slate-50 p-8 rounded-[2.5rem] transition-all duration-500 hover:bg-white hover:ring-8 hover:ring-slate-50"
            >
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <Link 
                  href="/booking" 
                  className="size-10 bg-white rounded-full flex items-center justify-center text-slate-400 group-hover:bg-[#66B21D] group-hover:text-white transition-all"
                >
