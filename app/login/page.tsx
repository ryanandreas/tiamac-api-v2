      ...
      <div className="hidden lg:flex flex-1 bg-slate-50 relative items-center justify-center p-12 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center gap-12 max-w-lg">
          <div className="relative group">
            ...
            {/* Floating Stats Card */}
            <div className="absolute -bottom-6 -left-12 bg-linear-to-br from-[#66B21D]/40 via-white/40 to-white/10 backdrop-blur-xl p-6 rounded-3xl flex items-center gap-4 animate-bounce-slow">
              ...
              <div className="text-left">
                <div className="text-[10px] font-extrabold text-slate-600 uppercase tracking-widest mb-0.5">Puas & Bergaransi</div>
                <div className="text-xl font-black text-slate-950 tracking-tight">12.4k+ Pelanggan</div>
              </div>
            </div>
          </div>
