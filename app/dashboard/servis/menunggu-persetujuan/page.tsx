...
export default async function MenungguPersetujuanPage() {
  ...
  return (
    <SidebarInset>
      <DashboardHeader title="Menunggu Persetujuan" />
      <div className="flex-1 space-y-4 p-8 pt-6">
        <div className="flex items-center justify-between space-y-2">
          <h2 className="text-3xl font-bold tracking-tight">Menunggu Persetujuan Customer</h2>
        </div>
        <div className="hidden h-full flex-1 flex-col space-y-8 md:flex">
          <div className="flex items-center justify-between space-y-2">
            <div>
              <p className="text-muted-foreground">
                Pesanan yang menunggu persetujuan biaya dari customer.
              </p>
            </div>
          </div>
