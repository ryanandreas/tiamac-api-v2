                ...
                <TableRow>
                  <TableCell colSpan={6} className="text-center py-32">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-[11px] font-black text-slate-400 uppercase tracking-widest">Gudang Kosong</p>
                    </div>
                  </TableCell>
                </TableRow>
              ) : (
                items.map((item) => (
                  <TableRow key={item.id} className="border-slate-50 hover:bg-slate-50/30 transition-colors group">
                    <TableCell className="py-6 pl-8">
                       <span className="text-[10px] font-black text-slate-400 group-hover:text-[#66B21D] transition-colors leading-none tracking-widest">#{item.sku}</span>
                    </TableCell>
                    <TableCell className="py-6">
                       <p className="text-sm font-black text-slate-900 group-hover:text-[#66B21D] transition-colors">{item.nama}</p>
                    ...
                    <TableCell className="py-6 text-center">
                      {item.qtyOnHand <= (item.minStock || 0) ? (
                        <Badge className="bg-red-50 text-red-600 border-none text-[9px] font-black uppercase tracking-widest rounded-lg px-2 py-1">STOK RENDAH</Badge>
                      ) : (
                        <Badge className="bg-green-50 text-green-600 border-none text-[9px] font-black uppercase tracking-widest rounded-lg px-2 py-1">TERSEDIA</Badge>
                      )}
                    </TableCell>
